...
const generateAccessAndRefereshTokens = async (userId) => {
  try {
    ...
    throw new ApiError(
      500,
      "Something went worng while generating refresh and token",
    );
  }
};
...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  .status(200),
  json(
    new ApiResponse(200, "Account detalis updated successfully")
  )
});
...
export { registerUsers, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails,updateUserAvatar, updateCoverImage};